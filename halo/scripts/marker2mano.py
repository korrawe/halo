...
parser.add_argument('--data_file', type=str, default='/ps/scratch/kkarunratanakul/FHB/Hand_pose_annotation_v1/Subject_1/charge_cell_phone/1/skeleton.txt', help='Path to file skeleton.txt')
...
def marker2mano(arg_data_file = '/ps/scratch/kkarunratanakul/FHB/Hand_pose_annotation_v1/Subject_1/charge_cell_phone/1/skeleton.txt',\
    ...
    for frameId in range(0, data_size, batch_size):
        ...
        for i in range(0, current_batch_size):
            ...
            # for meta data
            output_new_path = os.path.join(output_dir, instance_out, frame_num + '.npy')

            # print(output_new_path)
            hand_model_output_dir = os.path.dirname(output_new_path)
...
if __name__ == '__main__':
    ...
    train_split = False
    fhb_path = '/ps/scratch/kkarunratanakul/FHB/'
    fhb_model_outdir = '/ps/scratch/kkarunratanakul/FHB/mesh/meta'
    if train_split:
        split = 'train'
    else:
        split = 'test'
