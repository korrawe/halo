            ...
            if joints is not None:
                ...
                for b in range(20):
                    ax.plot([b_start_loc[b, 0, 0], b_end_loc[b, 0, 0]], 
                            ...
                            [b_start_loc[b, 2, 0], b_end_loc[b, 2, 0]], color='k',
                            linewidth=2)
        
                
                ax.scatter(
                        b_start_loc[:, 0], b_start_loc[:, 1], b_start_loc[:, 2],
                        color='r', s=40, marker='o')
                """
                ax.scatter(
                        b_end_loc[:, 0], b_end_loc[:, 1], b_end_loc[:, 2],
                        color='g', s=40, marker='o')
                """
